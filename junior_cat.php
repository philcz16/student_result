...
<html lang="en-US">
   ...
   <div id="wrapper">
	  ...
	  <div class="navi"><p>Update section for junior category</p></div>
	  	  <div class="sub-section">
		<div class="search-class">
		
		 <form action="process_updateres1.php" method="POST" id="form-register">
		...
		<?php $query=mysqli_query($con,"SELECT * FROM sub_junior ORDER BY subname ASC");
		...
		<?php $query=mysqli_query($con,"SELECT * FROM class WHERE class_name LIKE '%JSS%' ORDER BY class_name ASC");
